...
namespace WinterWay.Migrations
{
    ...
    [Migration("20250414210348_AddDiary")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Diary.DiaryRecordActivityModel", b =>
                {
                    ...
                    b.Property<int?>("DiaryActivityModelId")
                        .HasColumnType("integer");

                    b.Property<int>("DiaryGroupId")
                        .HasColumnType("integer");

                    b.Property<int?>("DiaryRecordGroupModelId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DiaryActivityModelId");

                    b.HasIndex("DiaryGroupId");

                    b.HasIndex("DiaryRecordGroupModelId");
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Diary.DiaryRecordActivityModel", b =>
                {
                    b.HasOne("WinterWay.Models.Database.Diary.DiaryRecordActivityModel", "DiaryActivity")
                        .WithMany()
                        .HasForeignKey("DiaryActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WinterWay.Models.Database.Diary.DiaryActivityModel", null)
                        .WithMany("RecordActivities")
                        .HasForeignKey("DiaryActivityModelId");
                    ...
                    b.HasOne("WinterWay.Models.Database.Diary.DiaryRecordGroupModel", null)
                        .WithMany("Activities")
                        .HasForeignKey("DiaryRecordGroupModelId");
