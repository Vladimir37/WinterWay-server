...
namespace WinterWay.Migrations
{
    ...
    [Migration("20260718202936_TaskDistribution")]
    partial class TaskDistribution
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarModel", b =>
                {
                    ...
                    b.Property<int?>("DefaultRecordId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordBooleanModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CalendarRecordBooleans");
                });

            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordFixedModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CalendarRecordFixeds");
                });
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordNumericModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CalendarRecordNumerics");
                });

            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordTimeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarModel", b =>
                {
                    b.HasOne("WinterWay.Models.Database.Calendar.CalendarRecordModel", "DefaultRecord")
                        .WithMany()
                        .HasForeignKey("DefaultRecordId")
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordBooleanModel", b =>
                {
                    b.HasOne("WinterWay.Models.Database.Calendar.CalendarRecordModel", "CalendarRecord")
                        .WithOne("BooleanVal")
                        .HasForeignKey("WinterWay.Models.Database.Calendar.CalendarRecordBooleanModel", "CalendarRecordId");
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordFixedModel", b =>
                {
                    b.HasOne("WinterWay.Models.Database.Calendar.CalendarRecordModel", "CalendarRecord")
                        .WithOne("FixedVal")
                        .HasForeignKey("WinterWay.Models.Database.Calendar.CalendarRecordFixedModel", "CalendarRecordId");

                    b.HasOne("WinterWay.Models.Database.Calendar.CalendarValueModel", "FixedValue")
                        .WithMany("CalendarFixedRecords")
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordNumericModel", b =>
                {
                    b.HasOne("WinterWay.Models.Database.Calendar.CalendarRecordModel", "CalendarRecord")
                        .WithOne("NumericVal")
                        .HasForeignKey("WinterWay.Models.Database.Calendar.CalendarRecordNumericModel", "CalendarRecordId");
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordTimeModel", b =>
                {
                    b.HasOne("WinterWay.Models.Database.Calendar.CalendarRecordModel", "CalendarRecord")
                        .WithOne("TimeVal")
                        .HasForeignKey("WinterWay.Models.Database.Calendar.CalendarRecordTimeModel", "CalendarRecordId");
            ...
            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarRecordModel", b =>
                {
                    b.Navigation("BooleanVal");

                    b.Navigation("FixedVal");

                    b.Navigation("NumericVal");

                    b.Navigation("TimeVal");
                });

            modelBuilder.Entity("WinterWay.Models.Database.Calendar.CalendarValueModel", b =>
                {
                    b.Navigation("CalendarFixedRecords");
                });
